...
int main()
{
	...
	STK_CTRL		|= (0x1<<1);//setting first bit to select SYS_TICK_interrupt method
	STK_LOAD 		 =16000000  -1;//loading 1600000 to reload register
	while(1)
	{
...
{
	GPIOB_ODR ^=(0x1<<13 );//Toggleing RED LED
}
