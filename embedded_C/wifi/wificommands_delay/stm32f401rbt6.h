...
#define GPIOC_AFRL      *(int*)0x40020820 //physical Address of GPIOA_AFRL
...
//USART-6
#define USART6_SR				*(int*) 0x40011400 //physical address of USART2_SR
#define USART6_DR				*(int*) 0x40011404 //physical address of USART2_DR
#define USART6_BRR			*(int*) 0x40011408 //physical address of USART2_BRR
#define USART6_CR1			*(int*) 0x4001140C //physical address of USART2_CR1
#define USART6_CR2			*(int*) 0x40011410 //physical address of USART2_CR2
#define USART6_CR3			*(int*) 0x40011414 //physical address of USART2_CR3
